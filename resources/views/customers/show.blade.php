...
@section('breadcrumb')
    ...
    <li class="breadcrumb-item">{{ Str::limit($customer->name) }}</li>
@endsection
@section('content')
        ...
        as $visit)
                        ...
                        <div class="card-footer card-comments">
                            @foreach ($visit->comments as $comment)
                                <div class="card-comment">
                                    <!-- User image -->
                                    <img class="img-circle img-sm" src="{{ $comment->author->gravatar() }}"
                                        alt="User Image">
            ...
            {{-- <div class="modal fade" id="exampleModal" tabindex="-1"
                ...
                <div class="modal-dialog">
                    <form action="{{ route('visits.delete') }}/delete}}" method="POST">
                        @csrf
                        @method('delete')
