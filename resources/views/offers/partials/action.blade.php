                ...
                @can('openworld')
                    <form action="{{ route('offers.destroy', $offer->slug) }}" method="POST">
                        ...
                        <button class="dropdown-item" name="approval" type="submit"
                            onclick="return confirm('apakah anda yakin?')" title="Hapus Penawaran. (only superadmin does)">
            ...
            <div class="dropdown-menu">
                ...
                @can('approval')
                    ...
                    <a href="{{ route('verify.offer.approve', $offer->slug) }}" class="dropdown-item"
                        title="Setujui Penawaran ini."> <i class="far fa-check-circle nav-icon"></i> Approve.
                    </a>
