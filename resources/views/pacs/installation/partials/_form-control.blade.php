    ...
    <div class="row justify-content-center">
        <div class="col-md-6">
            <div class="form-group">
                ...
                <div class="input-group">
                    @if (@$pacsInstallation->hospital->name)
                        <input type="text" disabled value="{{ $pacsInstallation->hospital->name }}" class="form-control">
                    @else
            ...
            <div class="form-group">
                ...
                <input type="date" name="handover_date" id="handover_date" class="form-control" value="{{ old('handover_date') ?? date('Y-m-d', strtotime($pacsInstallation->handover_date ?? now())) }}">
            </div>
            ...
            <div class="form-group">
                ...
                <input type="date" name="start_installation_date" id="start_installation_date"
                    max="{{ now()->addDays(3)->format('Y-m-d') }}" class="form-control" value="{{ old('start_installation_date') ?? date('Y-m-d', strtotime($pacsInstallation->start_installation_date ?? now())) }}">
            </div>
            ...
            <div class="form-group">
                ...
                <input type="date" name="training_date" id="training_date"
                    max="{{ now()->format('Y-m-d') }}" class="form-control" value="{{ old('training_date') ?? date('Y-m-d', strtotime($pacsInstallation->training_date ?? now())) }}">
            </div>
            ...
            <div class="form-group">
                ...
                <input type="date" name="finish_installation_date" id="finish_installation_date"
                    max="{{ now()->format('Y-m-d') }}" class="form-control" value="{{ old('finish_installation_date') ?? date('Y-m-d', strtotime($pacsInstallation->finish_installation_date ?? now())) }}">
            </div>

            {{-- Warranty Start --}}
            <div class="form-group">
                <label for="warranty_start">Tgl. Mulai Garansi*</label>
                <input type="date" name="warranty_start" id="warranty_start" class="form-control" value="{{ old('warranty_start') ?? date('Y-m-d', strtotime($pacsInstallation->warranty_start ?? now())) }}">
            </div>

            {{-- Warranty End --}}
            <div class="form-group">
                <label for="warranty_end">Tgl. Akhir Garansi*</label>
                <input type="date" name="warranty_end" id="warranty_end" class="form-control" value="{{ old('warranty_end') ?? date('Y-m-d', strtotime($pacsInstallation->warranty_end ?? now())) }}">
            </div>
        ...
        <div class="col-md-6">
            <div class="form-group">
                ...
                <input type="text" name="it_hospital_name" id="it_hospital_name" class="form-control"
                    placeholder="Tuliskan nama IT Rumah Sakit.." value="{{ old('it_hospital_name') ?? $pacsInstallation->stakeholder->it_hospital_name ?? '' }}">
            </div>

            <div class="form-group">
                <label for="phone_it">No. HP IT RS</label>
                <input type="number" name="phone_it" id="phone_it" class="form-control" placeholder="cth: 08429589035" value="{{ old('phone_it') ?? $pacsInstallation->stakeholder->phone_it ?? '' }}">
            </div>

            <div class="form-group">
                <label for="email_it">Email IT RS</label>
                <input type="email" name="email_it" id="email_it" class="form-control" placeholder="example@mail.com" value="{{ old('email_it') ?? $pacsInstallation->stakeholder->email_it ?? '' }}">
            </div>
            ...
            <div class="form-group">
                ...
                <input type="text" name="radiographer_name" id="radiographer_name" class="form-control"
                    placeholder="Tuliskan nama Radiographer Rumah Sakit.." value="{{ old('radiographer_name') ?? $pacsInstallation->stakeholder->radiographer_name ?? '' }}">
            </div>
            ...
            <div class="form-group">
                ...
                <input type="number" name="phone_radiographer" id="phone_radiographer" class="form-control"
                    placeholder="cth: 08947859" value="{{ old('phone_radiographer') ?? $pacsInstallation->stakeholder->phone_radiographer ?? '' }}">
            </div>
            ...
            <div class="form-group">
                ...
                <input type="email" name="email_radiographer" id="email_radiographer" class="form-control"
                    placeholder="example@mail.com" value="{{ old('email_radiographer') ?? $pacsInstallation->stakeholder->email_radiographer ?? '' }}">
            </div>
            ...
            <div class="form-group">
                ...
                <input type="text" name="radiology_name" id="radiology_name" class="form-control"
                    placeholder="Tuliskan nama Dokter Radiologi.." value="{{ old('radiology_name') ?? $pacsInstallation->stakeholder->radiology_name ?? '' }}">
            </div>
            ...
            <div class="form-group">
                ...
                <input type="number" name="phone_radiology" id="phone_radiology" class="form-control"
                    placeholder="cth: 0812395849" value="{{ old('phone_radiology') ?? $pacsInstallation->stakeholder->phone_radiology ?? '' }}">
            </div>
            ...
            <div class="form-group">
                ...
                <input type="email" name="email_radiology" id="email_radiology" class="form-control"
                    placeholder="example@mail.com" value="{{ old('email_radiology') ?? $pacsInstallation->stakeholder->email_radiology ?? '' }}">
            </div>
