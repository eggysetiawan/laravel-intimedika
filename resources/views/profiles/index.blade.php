@extends('layouts.app', ['title'=> $profile ?? auth()->user()->name,
'caption'=> $profile ?? 'My Profile'])

@section('breadcrumb')
    <li class="breadcrumb-item">{{ $profile ?? 'My Profile' }}</li>
@endsection
@section('content')
    <div class="row">
        <div class="col-md-3">
            ...
            <div class="card card-teal card-outline">
                <div class="card-body box-profile">
                    ...
                    @if (auth()->id() == $user->id)
                        <a href="{{ route('profiles.edit', $user->username) }}" class="btn bg-teal btn-block"><b>Edit
                                Profile</b></a>
                    @endif
                    ...
                    <div class="tab-content">
                        ...
                        <div class="tab-pane" id="timeline">
                            ...
                            <div class="timeline timeline-inverse">
                                ...
                                <!-- timeline item -->
                                <div>
                                    <i class="fas fa-envelope bg-teal"></i>
