        ...
        <div class="card card-widget">
            ...
            <div class="card-header">
                ...
                <div class="card-tools">
                    <button title="Minimize" type="button" class="btn btn-tool" data-card-widget="collapse"><i class="fas fa-minus"></i>
                    </button>
                    @can('update', $visit)
                    ...
                    @can('delete', $visit)
                    <button type="button" title="Hapus" data-toggle="modal" data-target="#exampleModal" class="btn btn-tool"><i class="fas fa-times"></i>
                    </button>
                    @endcan
                </div>
                <!-- /.card-tools -->
            ...
            <div class="card-body">
                ...
                <img class="img-fluid pad" style="height:270px;object-fit:cover;object-position:center;width:600px" src="{{ asset($visit->getFirstMedia('images')->getUrl()) }}" alt="Photo">
                @endif
